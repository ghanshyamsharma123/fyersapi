...
totp_key = "LCISZEOV5QLH2GXLF3JM6VX24PTRHQSQ"  # totp_key (ex., "OMKRABCDCDVDFGECLWXK6OVB7T4DTKU5")
username = "YY02787"  # Fyers Client ID (ex., "TK01248")
pin = 1804  # four-digit PIN
client_id = "XEFOEHY3RT-100"  # App ID of the created app (ex., "L9NY305RTW-100")
secret_key = "YLV6O113EU"  # Secret ID of the created app
